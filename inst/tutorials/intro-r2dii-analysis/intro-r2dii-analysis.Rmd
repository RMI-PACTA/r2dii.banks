...
```{r prioritize, exercise=TRUE, exercise.eval=TRUE, exercise.setup="packages"}
...
```{r sda, exercise=TRUE, exercise.eval=TRUE, exercise.setup="prioritize"}
matched %>%
  target_sda(
    ald = ald_demo,
...
```{r share, exercise=TRUE, exercise.eval=TRUE, exercise.setup="sda"}
matched %>%
  target_market_share(
    ald = ald_demo,
...
```{r company, exercise=TRUE, exercise.eval=TRUE, exercise.setup="share"}
matched %>%
  target_market_share(
    ald = ald_demo,
    scenario = scenario_demo_2020,
...
```{r join, exercise=TRUE, exercise.eval=TRUE, exercise.setup="company"}
...
```{r production, exercise=TRUE, exercise.eval=TRUE, exercise.setup="join"}
# portfolio level
