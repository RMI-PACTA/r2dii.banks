...
```{r market-share-targets-company, exercise.setup='market-share-targets-portfolio'}
...
```{r sda-targets, exercise.setup='market-share-targets-company'}
...
```{r technoloy-mix-portfolio, exercise.setup='sda-targets'}
...
```{r targets-and-ceiling, exercise.setup='plot-metric-versus-weighted-capacity'}
