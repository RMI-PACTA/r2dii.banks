...
```{r share-warning, exercise.setup='market-share-targets-portfolio'}
...
```{r share-df, exercise.setup='share-warning'}
...
```{r sda-warning, exercise.setup='share-df'}
...
```{r sda-df, exercise.setup='sda-warning'}
sda_targets
```
...
```{r tec-mix, exercise.setup='sda-df'}
...
```{r targets-and-ceiling-warning, exercise.setup='tec-mix'}
...
```{r targets-and-ceiling-plot, exercise.setup='targets-and-ceiling-warning'}
...
```{r sda-plot, exercise.setup='targets-and-ceiling-plot'}
ggplot(
  data = sda_targets,
  mapping = aes(
    x = year,
