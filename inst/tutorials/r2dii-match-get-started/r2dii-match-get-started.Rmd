...
```{r unlabeled-18, exercise.setup='setup'}
...
```{r unlabeled-29, exercise.setup='unlabeled-18'}
...
```{r unlabeled-36, exercise.setup='unlabeled-29'}
loanbook_demo
...
```{r unlabeled-67, exercise.setup='unlabeled-36'}
...
```{r unlabeled-87, exercise.setup='unlabeled-67'}
...
```{r unlabeled-93, exercise.setup='unlabeled-87'}
...
```{r unlabeled-104, exercise.setup='unlabeled-93'}
...
```{r unlabeled-119, exercise.setup='unlabeled-104'}
matched <- match_name(
...
```{r validate-matches, eval=FALSE, exercise=FALSE, include=FALSE, exercise.setup='unlabeled-119'}
...
```{r unlabeled-163, exercise.setup='validate-matches'}
...
```{r unlabeled-176, exercise.setup='unlabeled-163'}
...
```{r unlabeled-182, exercise.setup='setup', exercise.setup='unlabeled-176'}
matched %>%
