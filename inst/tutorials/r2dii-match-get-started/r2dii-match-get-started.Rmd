...
```{r packages, exercise.setup='setup'}
...
```{r code-system, exercise.setup='packages'}
...
```{r loanbook, exercise.setup='code-system'}
loanbook_demo


```

```{r ald, exercise.setup='loanbook'}
ald_demo
...
```{r define-your-data, exercise.setup='ald'}
...
```{r show-match-name, exercise.setup='define-your-data'}
...
```{r by-sector-false, exercise.setup='show-match-name'}
match_name(your_loanbook, your_ald, by_sector = FALSE) %>%
  nrow()
```

```{r by-sector-true, exercise.setup='by-sector-false'}
# Compare
...
```{r matched, exercise.setup='by-sector-true'}
...
```{r overwrite, exercise.setup='matched'}
matched <- match_name(
...
```{r validate-matches, eval=FALSE, exercise=FALSE, include=FALSE, exercise.setup='overwrite', exercise.setup='validate-matches'}
...
```{r validate, exercise.setup='validate-matches'}
...
```{r priority, exercise.setup='validate'}
...
```{r select-interesting-columns, exercise.setup='priority'}
matched %>%
