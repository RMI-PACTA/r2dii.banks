...
We use the package r2dii.match to access the most important functions you'll learn about. We also use example datasets from the package r2dii.data.

```{r unlabeled-20, exercise.setup='setup'}
library(r2dii.data)
library(r2dii.match)
```
...
```{r unlabeled-27, exercise.setup='unlabeled-20'}
library(tidyverse)
```
...
```{r unlabeled-36, exercise.setup='unlabeled-27'}
...
```{r unlabeled-43, exercise.setup='unlabeled-36'}
loanbook_demo
...
```{r unlabeled-74, exercise.setup='unlabeled-43'}
...
```{r unlabeled-94, exercise.setup='unlabeled-74'}
...
```{r unlabeled-100, exercise.setup='unlabeled-94'}
...
```{r unlabeled-111, exercise.setup='unlabeled-100'}
...
```{r unlabeled-126, exercise.setup='unlabeled-111'}
matched <- match_name(
...
```{r validate-matches, eval=FALSE, exercise=FALSE, include=FALSE, exercise.setup='unlabeled-126'}
# Run and copy-pate to update this section
# writeLines(readLines("./_validate-matches.md"))
```
...
```{r unlabeled-170, exercise.setup='validate-matches'}
...
```{r unlabeled-183, exercise.setup='unlabeled-170'}
...
```{r unlabeled-189, exercise.setup='unlabeled-183'}
matched %>%
