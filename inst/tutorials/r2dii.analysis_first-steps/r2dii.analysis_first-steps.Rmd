...
```{r prioritize, exercise.setup='packages'}
...
```{r sda, exercise.setup='prioritize'}
matched %>%
target_sda(
ald = ald_demo,
...
```{r company, exercise.setup='share'}
matched %>%
target_market_share(
ald = ald_demo,
scenario = scenario_demo_2020,
...
```{r production, exercise.setup='join'}
# portfolio level
